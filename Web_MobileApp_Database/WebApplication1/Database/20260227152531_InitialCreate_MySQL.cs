    ...
    public partial class InitialCreate_MySQL : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReceiptUid = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RetailReceipts", x => x.ReceiptUid);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CalculatedFee = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DiscountAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AppliedReceiptUid = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParkingSessions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ParkingSessions_RetailReceipts_AppliedReceiptUid",
                        column: x => x.AppliedReceiptUid,
                        principalTable: "RetailReceipts",
                        principalColumn: "ReceiptUid",
            ...
            migrationBuilder.InsertData(
                table: "ParkingSlots",
                columns: new[] { "SlotId", "GridX", "GridY", "IsOccupied" },
                values: new object[,]
                {
                    { "A1", 1, 1, false },
                    { "A2", 2, 1, false },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParkingSessions_AppliedReceiptUid",
                table: "ParkingSessions",
                column: "AppliedReceiptUid");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletTransactions_OrderCode",
